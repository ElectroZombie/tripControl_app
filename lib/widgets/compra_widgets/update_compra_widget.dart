  ...
  return AlertDialog(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
              icon: const Icon(Icons.numbers),
              fillColor: colors.surface,
              labelText: "PRECIO DE UNIDAD EN CUP:",
              labelStyle: const TextStyle(fontSize: 10),
              filled: true,
              constraints: BoxConstraints.loose(const Size.fromHeight(35)),
              border: OutlineInputBorder(
    ...
    actions: [
      ...
      TextButton(
        style: dialogButtonStyleWidget(colors),
        onPressed: () {
          _actualizarCompra(context, compra, nombreCompra, cantU, pesoT,
              costoM2, ventaM1, trip,
              singleton: singleton);
          Navigator.pop(
...
_actualizarCompra(context, compra, nombreCompra, cantU, pesoT, costoM2, ventaM1,
    TripModel trip,
