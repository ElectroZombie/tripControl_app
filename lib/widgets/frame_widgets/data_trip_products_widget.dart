              ...
              child: Column(children: [
                ...
                FutureBuilder<List<CompraModel>>(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    ...
                    return tablaCompras(snapshot.data as List<CompraModel>,
                        context, trip, colors);
                  },
                ),
                ...
                FutureBuilder<List<GastoModel>>(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    ...
                    return tablaGastos(snapshot.data as List<GastoModel>,
                        context, trip, colors);
                  },
                ),
                const SizedBox(
...
Widget tablaGastos(List<GastoModel> lista, context, trip, colors) {
  return DataTable(
      columnSpacing: 10,
      border: TableBorder.all(
          width: 1,
